# Blazor Booking System WebApp

This repository contains my first Blazor web application, developed as a learning project to deepen my understanding of C# and ASP.NET. The primary focus of this project was on backend functionality rather than design or UI.
...
- **Firestore Document Database**: Learning how to interact with Firestore to store and retrieve application data.
...
While I developed most of this application independently, I received some assistance in the following areas:

- Setting up the connection to the Firestore document database.
- Implementing the homebrew login system.
